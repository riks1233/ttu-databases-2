...
(
	...
	CONSTRAINT FK_Auto_Töötaja FOREIGN KEY (registreerija_id) REFERENCES Tootaja (isik_id) ON DELETE No Action ON UPDATE Cascade
)
;
...
CREATE INDEX IXFK_Auto_Töötaja ON Auto (registreerija_id ASC)
;
